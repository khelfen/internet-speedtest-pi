...
package_dir = os.path.abspath(os.path.join(project_dir, "internet_speedtest_pi"))

sys.path.insert(0, project_dir)

import internet_speedtest_pi  # noqa: E402

# -- Project information -----------------------------------------------------

# General information about the project.
project = "internet-speedtest-pi"
author = internet_speedtest_pi.__author__
copyright = "2021, " + internet_speedtest_pi.__author__
...
version = internet_speedtest_pi.__version__
# The full version, including alpha/beta/rc tags.
release = internet_speedtest_pi.__version__
